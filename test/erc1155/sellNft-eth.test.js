...
const myErc1155TokenAbi = require('../../artifacts/contracts/v2/MyErc1155Token.sol/MyErc1155Token.json')
...
describe('sell nft eth', async () => {
    ...
    it("test ", async () => {
        console.log("owner nft balance:", await myNftContract.balanceOf(owner.address, 1));
        ...
        await myNftContract.setApprovalForAll(pairrouter.address, true)
